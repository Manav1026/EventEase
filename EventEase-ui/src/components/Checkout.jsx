            ...
            <div className="bg-white shadow rounded-lg p-4">
                ...
                {cart.length!==0?cart.map((productPlus) => (
                    <div key={productPlus.product._id}>
                        ...
                        <div className="mb-10">
                            <h2 className="text-lg font-semibold mt-2">Quantity: {productPlus.orderQuantity}</h2>
                            <h2 className="text-lg font-semibold mt-2">Start Date: {productPlus.startDate}</h2>
                            <h2 className="text-lg font-semibold mt-2">End Date: {productPlus.endDate}</h2>
                            <button
